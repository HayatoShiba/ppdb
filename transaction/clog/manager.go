...
func (mi *ManagerImpl) IsTxCommitted(txID txid.TxID) (bool, error) {
	state, err := mi.getState(txID)
	if err != nil {
...
func (mi *ManagerImpl) IsTxAborted(id txid.TxID) (bool, error) {
	state, err := mi.getState(id)
	if err != nil {
		return false, errors.Wrap(err, "getState failed")
	}
...
func (mi *ManagerImpl) SetStateCommitted(txID txid.TxID) error {
	if err := mi.updateState(txID, stateCommitted); err != nil {
...
// https://github.com/postgres/postgres/blob/75f49221c22286104f032827359783aa5f4e6646/src/backend/access/transam/clog.c#L162
func (mi *ManagerImpl) SetStateAborted(txID txid.TxID) error {
	if err := mi.updateState(txID, stateAborted); err != nil {
		return errors.Wrap(err, "updateState failed")
	}
	return nil
}
